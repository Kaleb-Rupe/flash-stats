...
const TradeDropdown = ({
  ...
  return (
    <motion.div
      ...
      className="mb-2 border border-gray-200 dark:border-gray-800 rounded-lg shadow-strong border-t ring-1 bg-tremor-background ring-tremor-ring dark:bg-dark-tremor-background dark:ring-dark-tremor-ring"
    >
      <motion.div
