    ...
    <Card>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <p className="text-sm font-semibold">{formatPercentage(winRate)}%</p>
        </div>
        <div>
        ...
        <div>
          <p className="text-xs text-gray-500 mb-2">Largest Trade</p>
          <div className="flex flex-row gap-2">
            <p className="text-xs text-center w-1/2 text-gray-500">Win</p>
            <p className="text-xs font-semibold text-green-500">
              {formatUSD(largestWin)}
            </p>
            <p className="text-xs text-center w-1/2 text-gray-500">Loss</p>
